-- ============================================================================
-- VTC Public Profiles - Landing Pages Marketing (VERSION CORRIGÉE)
-- ============================================================================
...
-- ⚠️  user_id est TEXT (pas UUID) pour correspondre à la table users existante
-- ============================================================================

-- Table des profils publics VTC
CREATE TABLE IF NOT EXISTS vtc_profiles (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  user_id TEXT REFERENCES users(id) ON DELETE CASCADE,  -- TEXT au lieu de UUID
...
CREATE POLICY "Users can manage their own profile"
  ...
  USING (auth.uid()::text = user_id);  -- Cast UUID vers TEXT
