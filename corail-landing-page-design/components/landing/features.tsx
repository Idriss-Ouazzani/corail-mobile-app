...
const features = [
  {
    ...
    description: "Les membres du réseau sont vérifiés (licence VTC, identité).",
  },
  {
    icon: Lock,
  ...
  },
  {
    ...
    description: "Demandes de course, réponses des chauffeurs, tout au même endroit.",
  },
  {
    icon: CreditCard,
    title: "Vous choisissez",
    description: "Recevez les propositions des chauffeurs et choisissez en toute liberté.",
  },
  {
    icon: Clock,
  ...
  },
  {
    ...
    description: "Contrat et tarif conclus directement avec le chauffeur de votre choix.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 min-w-0">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center min-w-0">
          ...
          <div className="order-1 lg:order-2 min-w-0">
            ...
            <p className="text-foreground/60 text-base sm:text-lg lg:text-xl leading-relaxed mb-12 max-w-lg break-words min-w-0">
              Recevez les demandes de course (site ou en direct), répondez avec vos tarifs, 
              gérez vos devis et factures. Tout pour piloter votre activité au quotidien.
            </p>
