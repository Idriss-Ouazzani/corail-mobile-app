          ...
          <div className="col-span-2 flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8">
            ...
            <div className="text-center sm:text-left">
              <p className="text-sm text-foreground/55 leading-relaxed mb-3">
                Portail de mise en relation entre clients et chauffeurs privés indépendants. 
                Outils gratuits pour le réseau.
              </p>
              <p className="text-xs text-foreground/45 leading-relaxed italic">
                Corail n&apos;est pas un transporteur. Aucune réservation de transport n&apos;est effectuée par Corail. 
                Les contrats et tarifs sont conclus directement entre le client et le chauffeur.
              </p>
            </div>
          </div>
        </div>
