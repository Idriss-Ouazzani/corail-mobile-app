        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="space-y-6 mb-12 text-left max-w-lg mx-auto">
            <p className="text-foreground/60 text-lg leading-relaxed">
              ...
              <br />
              Réservez une course depuis ici : votre demande est envoyée aux chauffeurs du réseau.
            </p>
            <p className="text-foreground/60 text-lg leading-relaxed">
              <strong className="text-foreground/90">Vous êtes chauffeur ?</strong>
              <br />
              Téléchargez l&apos;application pour recevoir les réservations et gérer votre activité.
            </p>
          </div>
