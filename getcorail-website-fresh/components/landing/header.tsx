    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background border-b border-border/60 shadow-sm">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-8">
        ...
        <div className="hidden lg:flex lg:items-center lg:gap-3">
          <Button
            size="sm"
            className="btn-primary-glow bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-7 py-2.5 h-auto text-[15px] font-medium shadow-sm transition-all duration-300"
            asChild
          >
