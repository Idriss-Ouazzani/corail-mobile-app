...
const steps = [
  {
    number: "01",
    icon: MapPin,
    title: "Vous définissez votre trajet",
    description: "Départ, arrivée, date, horaire et tarif.",
  },
  {
    number: "02",
    icon: MessageSquare,
    title: "Un professionnel confirme",
    description: "Un chauffeur indépendant valide la réservation.",
  },
  {
    number: "03",
    icon: Car,
    title: "Service assuré",
    description: "Vous réglez directement votre chauffeur.\nCorail agit exclusivement comme plateforme de mise en relation.",
  },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-20 lg:mb-24">
          ...
          <p className="text-foreground/60 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
            Trois étapes simples et transparentes.
          </p>
        </div>
            ...
            return (
              <div key={step.number} className="relative group">
                ...
                <div className="text-center">
                  ...
                  <p className="text-foreground/55 leading-relaxed max-w-sm mx-auto text-sm lg:text-base whitespace-pre-line">
                    {step.description}
                  </p>
                </div>
              </div>
