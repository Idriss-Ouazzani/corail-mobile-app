  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-xs text-muted-foreground">
        Fourchette indicative basée sur la distance. Indiquez le tarif recommandé ou votre budget ;
        un chauffeur disponible du réseau confirmera votre demande à ce tarif.
      </p>
    </div>
  );
}
